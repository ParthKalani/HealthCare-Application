 ...
 * @author parthkalani
 */
public class GetHelpFromEnlisteeJPanel extends javax.swing.JPanel {
    ...
    public GetHelpFromEnlisteeJPanel(JPanel userProcessContainer, UserAccount userAccount, EcoSystem ecoSystem) {
        initComponents();
     ...
     public void populateWorkRequestTable()
    {
        ...
        for(WorkRequest workRequest : userAccount.getWorkQueue().getWorkRequestList())
        {
          ...
          { 
           OrganRequest helpWorkRequest = (OrganRequest)workRequest; 
           Object[] rowData = new Object[5];
           rowData[0] = helpWorkRequest.getRequestId();
           rowData[1] = helpWorkRequest.getNeedOrgan().getHelp();
    ...
    private void createRequestButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createRequestButtonActionPerformed
       ...
       Organization org = null;
        for(Network network : ecoSystem.getNetworkList())
        {
         ...
         {
          if(e.getEnterpriseType().equals(Enterprise.EnterpriseType.ServiceP))
          {
