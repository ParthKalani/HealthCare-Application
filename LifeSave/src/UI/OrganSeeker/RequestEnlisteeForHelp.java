 ...
 * @author parthkalani
 */
public class RequestEnlisteeForHelp extends javax.swing.JPanel {
    ...
    /
    public RequestEnlisteeForHelp(JPanel userProcessContainer, UserAccount userAccount, Enlistee volunteer, FreeWillOrg organization,EcoSystem ecoSystem) {
        initComponents();
     ...
     for(WorkRequest workRequest : userAccount.getWorkQueue().getWorkRequestList())
        {
         if(workRequest.getWork().equalsIgnoreCase("Need Help"))
         {
           ...
           rowData[0] = ((OrganRequest)workRequest).getRequestId();
           rowData[1] = ((OrganRequest)workRequest).getNeedOrgan().getHelp();
           rowData[2] = dateFormat.format(workRequest.getReqDate());
    ...
    private void createRequestButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createRequestButtonActionPerformed
       ...
       JOptionPane.showMessageDialog(this, "Please Enter data in all the fields ", "warning", JOptionPane.PLAIN_MESSAGE);
        ...
        SubmitOrganRequestJPanel submitHelpRequestJPanel = new SubmitOrganRequestJPanel(userProcessContainer, userAccount,volunteer, needHelp, organization);
