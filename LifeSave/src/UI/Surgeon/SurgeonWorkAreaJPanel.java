 ...
 * @author parthkalani
 */
public class SurgeonWorkAreaJPanel extends javax.swing.JPanel {
    
        private JPanel userProcessContainer;
        private UserAccount userAccount;
        private SurgeonWorkRequest sdtdwr;
    
    public SurgeonWorkAreaJPanel(JPanel userProcessContainer, UserAccount userAccount) {
        initComponents();
    ...
    public void populateHelpSeekerComboBx()
    {
     ...
     for(WorkRequest request : userAccount.getWorkQueue().getWorkRequestList())
        {
        if(!request.getWork().equalsIgnoreCase(AccountManagerWorkRequest.REQUEST_APPROVAL))
        {
       ...
       {
        OrganSeeker customer = (OrganSeeker)request.getSender().getPerson();
    ...
    private void initComponents() {
        ...
        getAlertFromHH.setText("View Organ Seeker Details");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(sendMedicationsPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 801, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(sendMedicationsPanel)
                .addGap(25, 25, 25))
        );
    ...
    private void getDataForPatientActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_getDataForPatientActionPerformed
       ...
       OrganSeeker customer = (OrganSeeker)helpSeekerComboBx.getSelectedItem();
        ...
        for(WorkRequest request : userAccount.getWorkQueue().getWorkRequestList())
        {
         if(!(request.getWork().equalsIgnoreCase(AccountManagerWorkRequest.REQUEST_APPROVAL)))
         {
         OrganSeeker cust = (OrganSeeker)request.getSender().getPerson();
         if(cust.equals(customer))
         {
         sdtdwr = (SurgeonWorkRequest)request;    
    ...
    private void sendNewMedicationsBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendNewMedicationsBtnActionPerformed
        ...
        if(sdtdwr.getStatus().equalsIgnoreCase("Completed"))
        {
         ...
         sdtdwr.setStatus(AccountManagerWorkRequest.REQUEST_COMPLETED);
    ...
    private void viewDetailsJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewDetailsJButtonActionPerformed
     ...
     public void populateVitalSignsJTable(OrganSeeker customer)
    {   
        try
        {
