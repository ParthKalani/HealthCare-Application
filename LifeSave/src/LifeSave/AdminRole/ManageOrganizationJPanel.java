...
public class ManageOrganizationJPanel extends javax.swing.JPanel {
    ...
    public void populateOrganizationComboBox()
    {
      ...
      orgJComboBox.removeAllItems();
            ...
            if(enterprise.getEnterpriseType().getValue().equals(EnterpriseType.Charity.getValue()))
            {
              orgJComboBox.addItem(Type.Sponsor);
            }
            else if(enterprise.getEnterpriseType().getValue().equals(EnterpriseType.OrganSeeker.getValue()))
            {
             orgJComboBox.addItem(Type.OrganSeeker);  
             orgJComboBox.addItem(Type.AccountManager); 
            }
            else if(enterprise.getEnterpriseType().getValue().equals(EnterpriseType.Government.getValue()))
            {
             orgJComboBox.addItem(Type.HealthAuditor);  
            }
            else if(enterprise.getEnterpriseType().getValue().equals(EnterpriseType.ServiceP.getValue()))
            {
            orgJComboBox.addItem(Type.Enlistee);     
            orgJComboBox.addItem(Type.Mobility);
            }
            else if(enterprise.getEnterpriseType().getValue().equals(EnterpriseType.Medical.getValue()))
            {
            orgJComboBox.addItem(Type.Surgeon);     
            }
    ...
    private void initComponents() {
        ...
        jLayeredPane1.setLayer(orgJComboBox, javax.swing.JLayeredPane.DEFAULT_LAYER);
                    ...
                    .addGroup(jLayeredPane1Layout.createSequentialGroup()
                        ...
                        .addGroup(jLayeredPane1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jLayeredPane1Layout.createSequentialGroup()
                                ...
                                .addComponent(orgJComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 187, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void deleteNetworkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteNetworkActionPerformed
        ...
        int selectedRow = orgJTable.getSelectedRow();
        if(selectedRow >= 0)
        {
            ...
            if(dialogResult == JOptionPane.YES_OPTION)
            {
                ...
                Organization org = (Organization)orgJTable.getValueAt(selectedRow, 1);
