 ...
 */
    ...
    public class AccountManagerProcessRequestAreaJPanel extends javax.swing.JPanel {
    
    private JPanel userProcessContainer;
    private AccountManagerWorkRequest request;
    private  EcoSystem ecoSystem;
   
    public AccountManagerProcessRequestAreaJPanel(JPanel userProcessContainer, AccountManagerWorkRequest request, EcoSystem ecoSystem) {
        initComponents();
        this.userProcessContainer = userProcessContainer;
        this.request = request;
        this.ecoSystem = ecoSystem;
        resultComboBox.removeAllItems();
        resultComboBox.addItem(AccountManagerWorkRequest.REQUEST_APPROVED);
    ...
    private void backJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backJButtonActionPerformed
        ...
        AccountManagerWAJPanel supervisorWorkAreaJPanel = (AccountManagerWAJPanel) component;
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        if((request.getSender().getRole().toString()).equalsIgnoreCase("Enlistee"))
        {
        Enlistee enlistee = (Enlistee)request.getSender().getPerson();
        ...
        if(request.getTestResult().equals(AccountManagerWorkRequest.REQUEST_APPROVED))
        {
